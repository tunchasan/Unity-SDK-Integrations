...
{
    public class NPAndroidManifestPostProcessor : IPostGenerateGradleAndroidProject
    {
        public void OnPostGenerateGradleAndroidProject(string basePath)
        {
            AndroidManifest androidManifest = new AndroidManifest(GetManifestPath(basePath));

            if (NPSettings.Application.SupportedFeatures.UsesMediaLibrary || NPSettings.Application.SupportedFeatures.UsesWebView)
            {
